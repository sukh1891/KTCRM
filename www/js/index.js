...
$(".addclink").click(function(){
    $(".contdiv").fadeOut(500);
    $(".newcust").delay(500).fadeIn(500);
    $(".title i").delay(500).show(500);
});
$(".addslink").click(function(){
    $(".contdiv").fadeOut(500);
    $(".newsal").delay(500).fadeIn(500);
    $(".title i").delay(500).show(500);
    befaddsal();
});
